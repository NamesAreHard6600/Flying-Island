-- mission Mission_Skylance_Leaping_Control
...
Mission_Skylance_Leaping_Control = Mission_Infinite:new {
  Name = "Controled Tiles",
  ControlStickPos = Point(0,3),
  ControlStickId = nil,
}

function Mission_Skylance_Leaping_Control:StartMission()
...
function Control_Stick_Attack:GetSkillEffect(p1,p2)
  ...
  ret:AddScript(string.format([[
    Skylance_leapingTiles:move_tiles(%s,%s,'NAH_Leaping_Tile','moving_tile.png','invisible.png')
