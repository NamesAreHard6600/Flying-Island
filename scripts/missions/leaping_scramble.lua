-- mission Mission_Skylance_Leaping_Scramble
...
Mission_Skylance_Leaping_Scramble = Mission_Infinite:new {
  Name = "Leaping Tiles",
  Environment = "Env_Leaping_Scramble",
  MovingTiles = tiles,
}

function Mission_Skylance_Leaping_Scramble:StartMission()
...
Env_Leaping_Scramble = Environment:new{
  Name = "Leaping Tiles",
...
function Env_Leaping_Scramble:MarkBoard()
  if self.Ready then
...
function Env_Leaping_Scramble:IsEffect() return self.Ready end

function Env_Leaping_Scramble:Plan()
  self.Ready = true
  return false
end

function Env_Leaping_Scramble:ApplyEffect()
  ...
  Skylance_leapingTiles:move_tiles(from,to)
