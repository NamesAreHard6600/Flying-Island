...
-- create personality
local personality = CreatePilotPersonality("Skylance_ceo_label", "Kin Tanaka") --Second argument is CEO name, don't change the first
personality:AddDialogTable(dialog)
personality:AddDialogTable(dialog_missions)

-- create ceo
local ceo = easyEdit.ceo:add("Skylance_ceo_id")
